...
var strurl="dynamic-insert-rule-form.php?cate="+cat;
var req=getXMLHTTP();
function getCat(cat) {
//alert(cat);
                $("#flash").show();
...
<div class="container" style="width:1024px">
            ...
            <div class="login-panel panel panel-success">
                <div class="panel-heading">
					<h3 class="panel-title"><a href="admin_dashboard.php">Welcome - <?php echo $_SESSION['username'];?></a><p align="right" style="font-size:150%;"><a href="logout.php">Logout</a></p></h3>
					</div>
  ...
  <tr>
    ...
    <tr>
	<td width="27%" align="left" valign="middle"><strong>CATEGORY</strong></td>
    ...
    <td width="29%" align="left" valign="middle"><label>
      <select name="select" id="select"  onChange="getCat(this.value)">
        <option value="" name="0" selected="selected">SELECT VULNERABILITY</option>
<?php
	...
	$count=$i+1;
	echo "<option value=\"$count\" name=\"$count\">New Rule</option>";
	?>   
	</select>
    </label></td>
  </tr>
